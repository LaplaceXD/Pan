...
class Mailer {
  static create({ email, password }) {
    const msg = {
      ...
      html:
        `<p> Good day, welcome to Pan Co. We hope you will enjoy your time with us.</p>
  ...
  static reset({ email, password }) {
    const msg = {
      ...
      html:
        `<p> Good day, this email is to let you know that your password has been reset.</p>
                   <p>Here is your new password:</p>
                   <h1>` +
        password +
        `</h1>
  ...
  static change({ email, password }) {
    const msg = {
      ...
      html:
        `<p> Good day, this email is to let you know that your password has been recently changed.</p>
                   <p>Here is your new password:</p>
                   <h1>` +
        password +
        `</h1>
